...
const identifikatory = nezaplaceneObjednavky.map((objednavky) => {
  return objednavky.id;
});
const emaily = nezaplaceneObjednavky.map((objednavky) => {
  return objednavky.uzivatel.jmeno + ' ' + objednavky.uzivatel.email;
});
